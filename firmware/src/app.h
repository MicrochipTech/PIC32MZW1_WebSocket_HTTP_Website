...
typedef enum
{
    ...
    APP_STATE_TURN_ON_MCP9808,
    APP_STATE_WAIT_TURN_ON_MCP9808,
    APP_STATE_TURN_ON_OPT3001,
    APP_STATE_WAIT_TURN_ON_OPT3001,
    APP_STATE_READ_TEMP,
    APP_STATE_WAIT_READ_TEMP,
    APP_STATE_READ_LIGHT,
    APP_STATE_WAIT_READ_LIGHT,
    APP_STATE_ERROR,
    APP_STATE_IDLE,
    APP_STATE_WS_SEND,
